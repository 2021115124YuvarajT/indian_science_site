...
import Ur2 from "../../images/urtwo.gif"
import Ur1 from "../../images/urone.gif"
import Ur3 from "../../images/urthree.gif"
import Ur4 from "../../images/urfour.gif"
export default function Urdvha(){
    return(
        <div style={urdvha}>
            <h1 class='main_heading'>Urdvha Tiryagbyam</h1>
            <hr/>
