...
export default function Mishrank() {
    return (
        ...
        <p> <img style={{ 'margin-left': '200px' }} src={Num1bar} />=  7x 1  +  (-4) x 10  +    1 x 100  +  1 x 1000=  1067</p>
        ...
        <div>
            ...
            <div style={{ "margin-left": "200px" }}>
                ...
                <p>=<img style={forimage} src={Num5bar} /></p>
            </div>
        </div>
        <div>
        ...
        <div>
            ...
            <div style={{ "margin-left": "200px" }}>
                <p>{"->"} <img style={forimage} src={Num6bar} /> </p>
                <p>{"->"} <img style={forimage} src={Num7bar} /> </p>
            
            </div>
            <p >This process is similar to subtraction of 2 numbers with borrow. Doing the same for the hundreds digit '8', we get</p>
            <div style={{ "margin-left": "200px" }}>
            
            <p>{"->"} <img style={forimage} src={Num8bar} /> </p>
            <p>{"->"} <img style={forimage} src={Num9bar} /> </p>
            <p>{"->"} <img style={forimage} src={Num10bar} /> </p>
            </div>
